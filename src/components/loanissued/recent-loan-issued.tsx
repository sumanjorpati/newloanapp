...
import { LoanIssued as RecentLoanIssued } from "@ts-types/generated";
import { useTranslation } from "next-i18next";

type IProps = {
  loanIssueds: RecentLoanIssued[];
  title?: string;
};

const RecentLoanIssueds = ({ loanIssueds, title }: IProps) => {
...
export default RecentLoanIssueds;
