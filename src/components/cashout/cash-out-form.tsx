...
import { Control, FieldErrors, useForm, useWatch, useFormState } from "react-hook-form";
...
import { useCreateCashOutMutation } from "@data/cash-out/use-cash-out-create.mutation";
import { useUpdateCashOutMutation } from "@data/cash-out/use-cash-out-update.mutation";
...
export default function CreateOrUpdateCashOutForm({ initialValues }: IProps) {
  ...
  const { mutate: createCashOut, isLoading: creating } = useCreateCashOutMutation();
  const { mutate: updateCashOut, isLoading: updating } = useUpdateCashOutMutation();
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap my-5 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          <Input
            label={t("form:input-cash-out-amount")}
            {...register("amount")}
      ...
      <div className="mb-4 text-end">
        ...
        <Button loading={creating || updating}>
          {initialValues
            ? t("form:button-label-update-cash-out")
