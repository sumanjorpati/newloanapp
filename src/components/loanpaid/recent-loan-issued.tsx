...
import { LoanPaid as RecentLoanPaid } from "@ts-types/generated";
import { useTranslation } from "next-i18next";

type IProps = {
  loanPaids: RecentLoanPaid[];
  title?: string;
};

const RecentLoanPaids = ({ loanPaids, title }: IProps) => {
...
export default RecentLoanPaids;
