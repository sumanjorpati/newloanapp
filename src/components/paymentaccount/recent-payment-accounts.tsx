...
import { PaymentAccount as RecentPaymentAccount } from "@ts-types/generated";
import { useTranslation } from "next-i18next";

type IProps = {
  paymentAccounts: RecentPaymentAccount[];
  title?: string;
};

const RecentPaymentAccounts = ({ paymentAccounts, title }: IProps) => {
...
export default RecentPaymentAccounts;
