...
import { useCreateAdminMutation } from "@data/admin/use-admin-create.mutation";
import { useUpdateAdminMutation } from "@data/admin/use-admin-update.mutation";
...
export default function CreateOrUpdateAdminForm({ initialValues }: IProps) {
  ...
  const { mutate: createAdmin, isLoading: creating } = useCreateAdminMutation();
  const { mutate: updateAdmin, isLoading: updating } = useUpdateAdminMutation();
    ...
    />
      ...
      <div className="mb-4 text-end">
        ...
        <Button loading={creating || updating}>
          {initialValues
            ? t("form:button-label-update-admin")
