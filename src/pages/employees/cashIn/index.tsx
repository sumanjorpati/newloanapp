...
import CashInList from "@components/cashin/cash-in-list";
import { useCashInsQuery } from "@data/cash-in/use-cash-ins.query";

export default function CashIns() {
      ...
      <Card className="flex flex-col xl:flex-row items-center mb-8">
        <div className="md:w-1/4 mb-4 xl:mb-0">
          <h1 className="text-xl font-semibold text-heading">
            {t("common:sidebar-nav-item-cash-in")}
          </h1>
        </div>
        ...
        <div className="w-full xl:w-1/2 flex flex-col md:flex-row space-y-4 md:space-y-0 items-center ms-auto">
          ...
          <LinkButton
            href={`${EMPLOYEE_ROUTES.CASH_IN}/create`}
...
CashIns.authenticate = {
  permissions: staffOnly,
};
CashIns.Layout = Layout;
